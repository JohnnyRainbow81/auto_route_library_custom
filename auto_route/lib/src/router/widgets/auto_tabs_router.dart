...
class _AutoTabsRouterIndexedStackState extends AutoTabsRouterState with SingleTickerProviderStateMixin {
...
class _AutoTabsRouterPageViewState extends AutoTabsRouterState with _RouteAwareTabsMixin<AutoTabsRouter> {
  ...
  void _updatePageController() {
    // Achtung, added by Stefan
    _pageController = (widget as _AutoTabsRouterPageView).pageController ?? PageController(
...
class _AutoTabsRouterTabBarState extends AutoTabsRouterState with _RouteAwareTabsMixin<AutoTabsRouter>, TickerProviderStateMixin {
